...
public sealed record ModEntity
{
    ...
    public IReadOnlyCollection<ModEntity>? Dependencies => _dependencies.AsReadOnly();
    public ModEntity(ModId id, IReadOnlyCollection<ModEntity>? dependencies = default)
    {
        Id = id;
